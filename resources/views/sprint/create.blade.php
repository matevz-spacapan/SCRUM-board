                                            ...
                                            <div class="col-md-6">
                                                @if(isset($sprint))
                                                    <input id="start_date" type="date"
                                                           class="form-control @error('in_progress') is-invalid @enderror @error('start_date') is-invalid @enderror"
                                                           name="start_date"
                                            ...
                                            <div class="col-md-6">
                                                @if(isset($sprint))
                                                    <input id="end_date" type="date"
                                                           class="form-control @error('in_progress') is-invalid @enderror @error('end_date') is-invalid @enderror"
                                                           name="end_date"
