                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('task.store', [$project->id, $story->id]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" rows="5" required>{{ old('description') ?? $task->description }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="time_estimate" type="number" class="form-control @error('time_estimate') is-invalid @enderror" name="time_estimate" value="{{ old('time_estimate') ?? $task->time_estimate}}" min="1" max="100" required>
